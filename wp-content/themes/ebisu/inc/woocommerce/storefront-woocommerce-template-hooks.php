...
add_action( 'woocommerce_before_main_content',    'ebisu_before_content',                   10 );
add_action( 'woocommerce_after_main_content',     'ebisu_after_content',                    10 );
...
add_action( 'woocommerce_before_shop_loop',       'ebisu_catalog_ordering',                 10 );
...
//add_action( 'woocommerce_after_shop_loop',        'ebisu_catalog_ordering',                 10 );
