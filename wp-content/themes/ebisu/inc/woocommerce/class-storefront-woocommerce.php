...
if ( ! class_exists( 'Storefront_WooCommerce' ) ) :
	...
	class Storefront_WooCommerce {
      ...
      /** ebisu css */
      wp_enqueue_style( 'ebisu-style', get_template_directory_uri() . '/css/ebisu.css', '', $storefront_version );

      /** ebisu js */
      wp_enqueue_script( 'ebisu-js', get_template_directory_uri() . '/js/base.js', '', $storefront_version);
