 ...
 */
add_action( 'ebisu_section_our_products', 'ebisu_slide_our_product',      10);

/**
 * Ebisu 
 * Homepage - best seller
 */
add_action( 'ebisu_section_best_seller', 'ebisu_slide_best_seller',      10);

/**
 * Ebisu 
 * Homepage - best seller
 */
add_action( 'ebisu_section_relate_product', 'ebisu_slide_relate_product',      10);
...
/*
remove password strength and use my own
*/
