...
if ( ! class_exists( 'Storefront' ) ) :
	...
	class Storefront {
      ...
      */
			...
			$footer_widget_regions = apply_filters( 'storefront_footer_widget_regions', 3 );
      ...
      /** Fronts Ebisu 
      */
      $fonts_raleway_url = "https://fonts.googleapis.com/css?family=Raleway:400,900italic,900,800italic,800,700italic,700,600italic,600,500italic,500,400italic,300,300italic,200italic,200,100italic,100";
      wp_enqueue_style( 'google-fonts-raleway', $fonts_raleway_url, array(), null );

      $fonts_roboto_url = "https://fonts.googleapis.com/css?family=Roboto:400,700";
      wp_enqueue_style( 'google-fonts-roboto', $fonts_roboto_url, array(), null );      

      $fonts_robotoc_url = "https://fonts.googleapis.com/css?family=Roboto+Condensed:400,700";
      wp_enqueue_style( 'google-fonts-roboto-condensed', $fonts_robotoc_url, array(), null );
      ...
      /* add slick */
      wp_enqueue_style( 'slick-style',        get_template_directory_uri() . '/lib/slick/slick.css', '', $storefront_version );
      wp_enqueue_style( 'slick-style-theme',  get_template_directory_uri() . '/lib/slick/slick-theme.css', '', $storefront_version );
      wp_enqueue_script( 'slick-plugin',      get_template_directory_uri() . '/lib/slick/slick.min.js', '', $storefront_version);
